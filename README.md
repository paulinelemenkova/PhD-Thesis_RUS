...
Исходный код LaTeX научного отчёта (Report) / LaTeX source of the report.
...
| | |
|---|---|
| Название | Морфоструктурные особенности глубоководных желобов Тихого океана, проблема их происхождения |
| Тип / Type | Отчёт (Report) |
| Место, год | Москва, Россия — 2021 |
| Объём | 1–268 с. |
| Специальность | 25.00.03 — Геотектоника и геодинамика |
| Язык / Language | Русский (rus) |
...
@report{Lemenkova202115,
    ...
    title        = {{Morphostructural features of the deep-sea trenches in the Pacific Ocean, the problem of their origin (Report)}},
    howpublished = {online},
    address      = {Moscow, Russia},
    doi          = {10.5281/zenodo.4885452},
    pages        = {1--268},
    language     = {russian},
    langid       = {english},
    year         = 2021}
